...
const images = {
    //CompassLogo: require('../Images/CompassLogo.png'),
    Settings: require('../Images/Icons/settings-icon.png'),
    ...
    KimTimeline: require('../Images/kimtimeline.jpg'),

    TyProfilePic: require('../Images/Profiles/ProfilePictures/ty-circle.png'),
